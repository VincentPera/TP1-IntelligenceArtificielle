...
void QuenchThirst::Execute(Miner* pMiner)
{
  ...
  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Un bon whiskey bien frais !";  
}
...
{
  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Let's Fight SeLbastien !";
}
...
void FightForPride::Execute(Miner* pMiner)
{
  if(pMiner->FatiguedForFight()){
	  if(pMiner->GoldCarried()>1){
		  ...
		  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " 
          << "J'ai perdu et je peux payer ma tounée générale";
		  ...
		  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " 
          << "J'ai perdu et j'ai pas assez pour payer, une autre fois !";
...
{
  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Tournee !";
}

void RoundForEveryone::Execute(Miner* pMiner)
{
  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Tastes a real good tournee generale!";
...
{ 
  cout << "\n" << GetNameOfEntity(pMiner->ID()) << ": " << "Retour au travail";
}
