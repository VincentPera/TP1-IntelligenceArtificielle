...
//  keep going to get more gold
//------------------------------------------------------------------------
class FightForPride : public State<Miner>
{
private:
  ...
  //copy ctor and assignment should be private
  FightForPride(const FightForPride&);
  FightForPride& operator=(const FightForPride&);
...
//  keep going to get more gold
//------------------------------------------------------------------------
class RoundForEveryone : public State<Miner>
{
private:
  ...
  //copy ctor and assignment should be private
  RoundForEveryone(const RoundForEveryone&);
  RoundForEveryone& operator=(const RoundForEveryone&);
